...
CELL_SIZE = WIDTH // tablero_nuevo.maximo


# Dibujar la cuadrícula
def draw_grid():
    # Dibujar lineas
    for i in range(tablero_nuevo.maximo):
        width = 1
        #Líneas horizontales
    ...
    font = pygame.font.Font(None, 48)  # Fuente para los números
    ...
    for celda_actual in celdas:
        ...
        # else:
        #     font.italic = False
        #     text = font.render(str(celda_actual.max_posible), True, GRAY)
        #     text_rect = text.get_rect(
        #         center=((celda_actual.columna - 0.5) * CELL_SIZE, (celda_actual.fila - 0.5) * CELL_SIZE)
        #     )
        #     screen.blit(text, text_rect)
